...
<script runat="server">
    ...
    Sub Page_Load
        If (Session("login")) Then
            ...
            strSQL = "UPDATE deadlines SET author=@author,name=@name,description=@description,dueMonth=@dueMonth" & _
            ",dueDay=@dueDay,studentYear=@studentYear WHERE id=@id"
            ...
            DBCommand.Parameters.AddWithValue("@id", reader.SelectSingleNode("/deadline/@id").InnerText)
